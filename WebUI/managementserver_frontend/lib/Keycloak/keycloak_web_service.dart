...
class KeycloakWebService {
  ...
  String _generateCodeVerifier() {
    ...
    final random = List.generate(128, (_) => charset[DateTime.now().microsecondsSinceEpoch % charset.length]);
    return random.join();
  }
  ...
  Future<Map<String, dynamic>> _httpPost(String url, Map<String, String> body) async {
  ...
  Future<Map<String, dynamic>> _httpGet(String url, {String? bearerToken}) async {
    final request = html.HttpRequest();
